...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Using MLflow Tracking for building this demo](/images/tutorials/introductory/logging-first-model/dogfood-diagram.svg)
  <figcaption>Using Experiments in MLflow Tracking to keep track of building this tutorial</figcaption>
</figure>
...
<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Checking the results of the test](/images/tutorials/introductory/logging-first-model/dogfood.gif)
  <figcaption>Validating the results of a training run in the MLflow UI</figcaption>
</figure>

Once I found something that actually worked, I cleaned everything up (deleted them).

<figure className="center-div" style={{ width: 1024, maxWidth: "100%", textAlign: "center" }}>
  ![Tidying up](/images/tutorials/introductory/logging-first-model/cleanup-experiments.gif)
  <figcaption>Removing experiments that were filled with failed attempts</figcaption>
</figure>
...
<div className="center-div" style={{ width: 1024, maxWidth: "100%" }}>
  ![Explanation of MLflow integration into ML training code](/images/tutorials/introductory/logging-first-model/training-annotation.png)
</div>
...
<div className="center-div" style={{ width: 1024, maxWidth: "100%" }}>
  ![Log the model to MLflow](/images/tutorials/introductory/logging-first-model/logging-first-model.gif)
</div>

Congratulations on finishing the in-depth tutorial to MLflow tracking! You can now [return to the Getting Started](/ml/getting-started) content to learn more about MLflow.

If you would like to try out some notebooks to see how MLflow works in detail, you can navigate to the [Getting Started Notebooks](/ml/getting-started/logging-first-model/notebooks) to download examples locally and run them!
